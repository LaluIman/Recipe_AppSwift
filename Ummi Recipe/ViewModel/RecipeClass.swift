...
class RecipeManager:  ObservableObject {
    @Published var recipes: [Recipe] = [
        ...
        Recipe(title: "Classic Margherita Pizza", headline: "Lunch", time: "30 minute",
        ...
        Recipe(title: "Grilled Chicken Salad", headline: "Lunch", time: "30 minute",
        ...
        Recipe(title: "Baked Salmon", headline: "Dinner",time: "30 minute",
        ...
        Recipe(title: "Homestyle Beef Stew", headline: "Dinner",time: "30 minute",
